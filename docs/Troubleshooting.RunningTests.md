...
- **On Android**, there might be a problem with the native test code in the `DetoxTest.java` file. Revisit the [associated section](Introduction.BuildingWithDetox.mdx#5-create-a-detox-test-class) in the setup guide.
