...
import DetoxBuild from './Introduction.BuildingWithDetox.DetoxBuild.mdx';
...
_compiling dependency_ instead, consult the respective section in [Debugging in Android Studio During Detox Tests](Guide.DebuggingInAndroidStudio.md#todo-the-section) guide.
